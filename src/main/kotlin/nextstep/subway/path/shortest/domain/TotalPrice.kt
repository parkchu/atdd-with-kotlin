...
import nextstep.subway.path.shortest.domain.Age.CHILD
import nextstep.subway.path.shortest.domain.Age.TEENAGER
import nextstep.subway.path.shortest.domain.Distance.OVER_10KM
import nextstep.subway.path.shortest.domain.Distance.OVER_50KM
